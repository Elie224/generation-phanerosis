...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Recréer le trigger pour empêcher la modification des champs critiques de l'admin principal
        DB::unprepared('
        ...
        // Recréer le trigger pour empêcher la suppression de l'admin principal
        DB::unprepared('
        ...
        // Recréer le trigger pour empêcher la désactivation de l'admin principal
        DB::unprepared('
