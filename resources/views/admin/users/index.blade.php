            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="{{ $user->isMainAdmin() ? 'bg-yellow-50' : '' }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                    ...
                                    @elseif($user->role === 'pasteur') bg-blue-100 text-blue-800
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    @if($user->id !== auth()->id())
                                            ...
                                            @endif
                                        @else
                                            <span class="text-gray-400">Admin Principal - Non modifiable</span>
                                        @endif
                                    @else
                                        <span class="text-gray-400">Seul l'admin principal peut modifier</span>
                                    @endif
                                </div>
                            </td>
                        </tr>
