    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="relative mb-8">
                ...
                @else
                    <div class="w-full h-64 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600"></div>
                @endif
